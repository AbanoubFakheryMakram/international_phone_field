...
class _InputWidgetState extends State<InternationalPhoneNumberInput> {
      ...
      getParsedPhoneNumber(parsedPhoneNumberString, this.country?.alpha2Code).then((phoneNumber) {
        if (phoneNumber == null) {
          ...
          if (widget.onInputChanged != null) {
            this.phoneNumber = PhoneNumber(phoneNumber: phoneNumber, isoCode: this.country?.alpha2Code, dialCode: this.country?.dialCode);
            widget.onInputChanged!(this.phoneNumber!);
          }
  ...
  String? validator(String? value) {
    if(widget.isRequired) {
      ...
      if(value != null && value.isNotEmpty == true && isNotValid) {
        return "Enter valid phone number";
      } else {
        return null;
      }
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          hintText: "enter international phone number",
